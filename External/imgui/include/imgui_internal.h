...
struct ImGuiFocusScopeData
{
    ...
    ImGuiFocusScopeData(ImGuiID id, ImGuiID wid) : ID(id), WindowID(wid) {}
};
...
struct ImGuiMetricsConfig
{
    ...
    ImGuiMetricsConfig()
        : ShowDebugLog(false), ShowIDStackTool(false), ShowWindowsRects(false)
        , ShowWindowsBeginOrder(false), ShowTablesRects(false)
        , ShowDrawCmdMesh(true), ShowDrawCmdBoundingBoxes(true)
        , ShowTextEncodingViewer(false)
        , ShowWindowsRectsType(-1), ShowTablesRectsType(-1)
        , HighlightMonitorIdx(-1), HighlightViewportID(0) {}
};
...
struct ImGuiTableHeaderData
{
    ...
    ImU32                       BgColor0;
    ImU32                       BgColor1;
    ImGuiTableHeaderData() : Index(0), TextColor(0), BgColor0(0), BgColor1(0) {}
    ImGuiTableHeaderData(ImGuiTableColumnIdx idx, ImU32 tc, ImU32 bg0, ImU32 bg1) : Index(idx), TextColor(tc), BgColor0(bg0), BgColor1(bg1) {}
};
