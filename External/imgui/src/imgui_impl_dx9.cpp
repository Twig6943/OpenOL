...
static bool ImGui_ImplDX9_CheckFormatSupport(LPDIRECT3DDEVICE9 pDevice, D3DFORMAT format)
{
    ...
    if (pDevice->GetDirect3D(&pd3d) != D3D_OK)
        return false;
    D3DDEVICE_CREATION_PARAMETERS param; memset(&param, 0, sizeof(param));
    D3DDISPLAYMODE mode; memset(&mode, 0, sizeof(mode));
...
bool ImGui_ImplDX9_Init(IDirect3DDevice9* device)
{
    ...
    // IMGUI_CHECKVERSION() disabled: see imgui_impl_win32.cpp for rationale.
    //IMGUI_CHECKVERSION();
