...
static bool ImGui_ImplWin32_InitEx(void* hwnd, bool platform_has_own_dc)
{
    ...
    // IMGUI_CHECKVERSION() disabled: compiled in a separate MSVC project; struct sizes may
    // appear to differ due to distinct TU compile flags, triggering a false-positive assert.
    //IMGUI_CHECKVERSION();
...
static void ImGui_ImplWin32_UpdateGamepads(ImGuiIO& io)
{
    ...
    {
        XINPUT_CAPABILITIES caps; memset(&caps, 0, sizeof(caps));
...
static BOOL _IsWindowsVersionOrGreater(WORD major, WORD minor, WORD)
{
    ...
    RTL_OSVERSIONINFOEXW versionInfo; memset(&versionInfo, 0, sizeof(versionInfo));
