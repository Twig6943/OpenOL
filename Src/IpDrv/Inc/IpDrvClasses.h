...
struct UdpLink_eventReceivedBinary_Parms
{
    ...
    BYTE B[255];
    FIpAddr Addr;
    UdpLink_eventReceivedBinary_Parms(EEventParm)
    {
    }
};
struct UdpLink_eventReceivedText_Parms
{
    FString Text;
    FIpAddr Addr;
    UdpLink_eventReceivedText_Parms(EEventParm)
    {
    }
};
...
public:
    //## BEGIN PROPS UdpLink
    FUdpLinkProxy* UdpLinkProxy;
    //## END PROPS UdpLink

    virtual INT BindPort(INT PortNum=0);
    virtual UBOOL SendText(FIpAddr Addr,const FString& Str);
    virtual UBOOL SendBinary(FIpAddr Addr,INT Count,BYTE* B);
    DECLARE_FUNCTION(execBindPort)
    {
        P_GET_INT_OPTX(PortNum,0);
        P_FINISH;
        *(INT*)Result=this->BindPort(PortNum);
    }
    DECLARE_FUNCTION(execSendText)
    {
        P_GET_STRUCT(FIpAddr,Addr);
        P_GET_STR(Str);
        P_FINISH;
        *(UBOOL*)Result=this->SendText(Addr,Str);
    }
    DECLARE_FUNCTION(execSendBinary)
    {
        P_GET_STRUCT(FIpAddr,Addr);
        ...
        P_GET_ARRAY(BYTE,B);
        P_FINISH;
        *(UBOOL*)Result=this->SendBinary(Addr,Count,B);
    }
    void eventReceivedBinary(INT Count,BYTE* B,FIpAddr Addr)
    {
        UdpLink_eventReceivedBinary_Parms Parms(EC_EventParm);
        Parms.Count=Count;
        appMemcpy(Parms.B,B,sizeof(Parms.B));
        Parms.Addr=Addr;
        ProcessEvent(FindFunctionChecked(IPDRV_ReceivedBinary),&Parms);
    }
    void eventReceivedText(const FString& Text,FIpAddr Addr)
    {
        UdpLink_eventReceivedText_Parms Parms(EC_EventParm);
        Parms.Text=Text;
        Parms.Addr=Addr;
        ProcessEvent(FindFunctionChecked(IPDRV_ReceivedText),&Parms);
    }
...
public:
    ...
    void EndLocalClientAuthSession(struct FUniqueNetId ServerUID,FIpAddr ServerIP,INT ServerPort);
    void EndRemoteClientAuthSession(struct FUniqueNetId ClientUID,FIpAddr ClientIP);
    virtual void EndAllLocalClientAuthSessions();
    virtual void EndAllRemoteClientAuthSessions();
    void EndLocalServerAuthSession(struct FUniqueNetId ClientUID,FIpAddr ClientIP);
    void EndRemoteServerAuthSession(struct FUniqueNetId ServerUID,FIpAddr ServerIP);
    ...
    void delegateOnServerAuthResponse(struct FUniqueNetId ServerUID,FIpAddr ServerIP,INT AuthTicketUID)
    {
    ...
    void delegateOnClientAuthResponse(struct FUniqueNetId ClientUID,FIpAddr ClientIP,INT AuthTicketUID)
    {
    ...
    void delegateOnServerAuthRequest(class UPlayer* ClientConnection,struct FUniqueNetId ClientUID,FIpAddr ClientIP,INT ClientPort)
    {
    ...
    void delegateOnClientAuthRequest(struct FUniqueNetId ServerUID,FIpAddr ServerIP,INT ServerPort,UBOOL bSecure)
    {
...
struct OnlineGameInterfaceImpl_eventOnGetSessionMemberInfoComplete_Parms
{
    TArray<struct FSessionMemberInfo> SesionMemberInfo;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnGetSessionMemberInfoComplete_Parms(EEventParm)
    {
    }
};
...
struct OnlineGameInterfaceImpl_eventOnPokeInactivePlayersComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnPokeInactivePlayersComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnPullReservedPlayersIntoSessionComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnPullReservedPlayersIntoSessionComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnGetAvailablePlayersFromPartyComplete_Parms
{
    TArray<struct FUniqueNetId> Players;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnGetAvailablePlayersFromPartyComplete_Parms(EEventParm)
    {
    }
};
...
struct OnlineGameInterfaceImpl_eventOnJoinOnlineSessionComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnJoinOnlineSessionComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnQuerySessionsForUserComplete_Parms
{
    BYTE LocalPlayerNum;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnQuerySessionsForUserComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnLeaveOnlineSessionComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnLeaveOnlineSessionComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnMatchStatusChanged_Parms
{
    FName SessionName;
    BYTE Status;
    OnlineGameInterfaceImpl_eventOnMatchStatusChanged_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnGamePlayersChanged_Parms
{
    FName SessionName;
    TArray<struct FUniqueNetId> Players;
    OnlineGameInterfaceImpl_eventOnGamePlayersChanged_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnAcceptPendingGameSessionComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnAcceptPendingGameSessionComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnGameSessionReady_Parms
{
    FName SessionName;
    OnlineGameInterfaceImpl_eventOnGameSessionReady_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnUpdateSessionPropertiesComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnUpdateSessionPropertiesComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnDeleteMatchTicketComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnDeleteMatchTicketComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnQueryMatchmakingForSessionComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnQueryMatchmakingForSessionComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnRegisterGameSessionComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnRegisterGameSessionComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnAddSessionMemberComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnAddSessionMemberComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnCreateOnlineSessionComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnCreateOnlineSessionComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnMatchmakeOnlineGameWithPartyComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnMatchmakeOnlineGameWithPartyComplete_Parms(EEventParm)
    {
    }
};
struct OnlineGameInterfaceImpl_eventOnCreateOnlineGameWithPartyComplete_Parms
{
    FName SessionName;
    UBOOL bWasSuccessful;
    OnlineGameInterfaceImpl_eventOnCreateOnlineGameWithPartyComplete_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    FScriptDelegate __OnCreateOnlineGameWithPartyComplete__Delegate;
    FScriptDelegate __OnMatchmakeOnlineGameWithPartyComplete__Delegate;
    FScriptDelegate __OnCreateOnlineSessionComplete__Delegate;
    FScriptDelegate __OnAddSessionMemberComplete__Delegate;
    FScriptDelegate __OnRegisterGameSessionComplete__Delegate;
    FScriptDelegate __OnQueryMatchmakingForSessionComplete__Delegate;
    FScriptDelegate __OnDeleteMatchTicketComplete__Delegate;
    FScriptDelegate __OnUpdateSessionPropertiesComplete__Delegate;
    FScriptDelegate __OnGameSessionReady__Delegate;
    FScriptDelegate __OnAcceptPendingGameSessionComplete__Delegate;
    FScriptDelegate __OnGamePlayersChanged__Delegate;
    FScriptDelegate __OnMatchStatusChanged__Delegate;
    FScriptDelegate __OnLeaveOnlineSessionComplete__Delegate;
    FScriptDelegate __OnQuerySessionsForUserComplete__Delegate;
    FScriptDelegate __OnJoinOnlineSessionComplete__Delegate;
    ...
    FScriptDelegate __OnGetAvailablePlayersFromPartyComplete__Delegate;
    FScriptDelegate __OnPullReservedPlayersIntoSessionComplete__Delegate;
    FScriptDelegate __OnPokeInactivePlayersComplete__Delegate;
    FScriptDelegate __OnQosStatusChanged__Delegate;
    FScriptDelegate __OnGetSessionMemberInfoComplete__Delegate;
    ...
    void delegateOnGetSessionMemberInfoComplete(const TArray<struct FSessionMemberInfo>& SesionMemberInfo,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnGetSessionMemberInfoComplete_Parms Parms(EC_EventParm);
        Parms.SesionMemberInfo=SesionMemberInfo;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnGetSessionMemberInfoComplete,&__OnGetSessionMemberInfoComplete__Delegate,&Parms);
    }
    ...
    void delegateOnPokeInactivePlayersComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnPokeInactivePlayersComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnPokeInactivePlayersComplete,&__OnPokeInactivePlayersComplete__Delegate,&Parms);
    }
    void delegateOnPullReservedPlayersIntoSessionComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnPullReservedPlayersIntoSessionComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnPullReservedPlayersIntoSessionComplete,&__OnPullReservedPlayersIntoSessionComplete__Delegate,&Parms);
    }
    void delegateOnGetAvailablePlayersFromPartyComplete(const TArray<struct FUniqueNetId>& Players,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnGetAvailablePlayersFromPartyComplete_Parms Parms(EC_EventParm);
        Parms.Players=Players;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnGetAvailablePlayersFromPartyComplete,&__OnGetAvailablePlayersFromPartyComplete__Delegate,&Parms);
    }
    ...
    void delegateOnJoinOnlineSessionComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnJoinOnlineSessionComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnJoinOnlineSessionComplete,&__OnJoinOnlineSessionComplete__Delegate,&Parms);
    }
    void delegateOnQuerySessionsForUserComplete(BYTE LocalPlayerNum,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnQuerySessionsForUserComplete_Parms Parms(EC_EventParm);
        Parms.LocalPlayerNum=LocalPlayerNum;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnQuerySessionsForUserComplete,&__OnQuerySessionsForUserComplete__Delegate,&Parms);
    }
    void delegateOnLeaveOnlineSessionComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnLeaveOnlineSessionComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnLeaveOnlineSessionComplete,&__OnLeaveOnlineSessionComplete__Delegate,&Parms);
    }
    void delegateOnMatchStatusChanged(FName SessionName,BYTE Status)
    {
        OnlineGameInterfaceImpl_eventOnMatchStatusChanged_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.Status=Status;
        ProcessDelegate(IPDRV_OnMatchStatusChanged,&__OnMatchStatusChanged__Delegate,&Parms);
    }
    void delegateOnGamePlayersChanged(FName SessionName,const TArray<struct FUniqueNetId>& Players)
    {
        OnlineGameInterfaceImpl_eventOnGamePlayersChanged_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.Players=Players;
        ProcessDelegate(IPDRV_OnGamePlayersChanged,&__OnGamePlayersChanged__Delegate,&Parms);
    }
    void delegateOnAcceptPendingGameSessionComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnAcceptPendingGameSessionComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnAcceptPendingGameSessionComplete,&__OnAcceptPendingGameSessionComplete__Delegate,&Parms);
    }
    void delegateOnGameSessionReady(FName SessionName)
    {
        OnlineGameInterfaceImpl_eventOnGameSessionReady_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        ProcessDelegate(IPDRV_OnGameSessionReady,&__OnGameSessionReady__Delegate,&Parms);
    }
    void delegateOnUpdateSessionPropertiesComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnUpdateSessionPropertiesComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnUpdateSessionPropertiesComplete,&__OnUpdateSessionPropertiesComplete__Delegate,&Parms);
    }
    void delegateOnDeleteMatchTicketComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnDeleteMatchTicketComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnDeleteMatchTicketComplete,&__OnDeleteMatchTicketComplete__Delegate,&Parms);
    }
    void delegateOnQueryMatchmakingForSessionComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnQueryMatchmakingForSessionComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnQueryMatchmakingForSessionComplete,&__OnQueryMatchmakingForSessionComplete__Delegate,&Parms);
    }
    void delegateOnRegisterGameSessionComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnRegisterGameSessionComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnRegisterGameSessionComplete,&__OnRegisterGameSessionComplete__Delegate,&Parms);
    }
    void delegateOnAddSessionMemberComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnAddSessionMemberComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnAddSessionMemberComplete,&__OnAddSessionMemberComplete__Delegate,&Parms);
    }
    void delegateOnCreateOnlineSessionComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnCreateOnlineSessionComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnCreateOnlineSessionComplete,&__OnCreateOnlineSessionComplete__Delegate,&Parms);
    }
    void delegateOnMatchmakeOnlineGameWithPartyComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnMatchmakeOnlineGameWithPartyComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnMatchmakeOnlineGameWithPartyComplete,&__OnMatchmakeOnlineGameWithPartyComplete__Delegate,&Parms);
    }
    void delegateOnCreateOnlineGameWithPartyComplete(FName SessionName,UBOOL bWasSuccessful)
    {
        OnlineGameInterfaceImpl_eventOnCreateOnlineGameWithPartyComplete_Parms Parms(EC_EventParm);
        Parms.SessionName=SessionName;
        Parms.bWasSuccessful=bWasSuccessful ? FIRST_BITFIELD : FALSE;
        ProcessDelegate(IPDRV_OnCreateOnlineGameWithPartyComplete,&__OnCreateOnlineGameWithPartyComplete__Delegate,&Parms);
    }
...
#define AUTO_INITIALIZE_REGISTRANTS_IPDRV \
	...
	GNativeLookupFuncs.Set(FName("UdpLink"), GIpDrvAUdpLinkNatives); \
...
FNativeFunctionLookup GIpDrvAUdpLinkNatives[] = 
{ 
...
VERIFY_CLASS_OFFSET_NODIE(AUdpLink,UdpLink,UdpLinkProxy)
...
VERIFY_CLASS_OFFSET_NODIE(UOnlineGameInterfaceImpl,OnlineGameInterfaceImpl,__OnGetSessionMemberInfoComplete__Delegate)
