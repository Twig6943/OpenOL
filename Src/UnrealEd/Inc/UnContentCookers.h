...
extern DOUBLE		GRHIShaderCompileTime_DINGO;
...
//@zombie_ps4_begin
extern DOUBLE		GRHIShaderCompileTime_ORBIS;
//@zombie_ps4_end
...
struct FCookStats
{
	...
	DOUBLE	ExternGRHIShaderCompileTime_DINGO;
	...
	DOUBLE	ExternGRHIShaderCompileTime_PCD3D_SM4;
	DOUBLE	ExternGRHIShaderCompileTime_PCD3D_SM5;
	DOUBLE	ExternGRHIShaderCompileTime_PCOGL;
//@zombie_ps4_begin
	DOUBLE	ExternGRHIShaderCompileTime_ORBIS;
//@zombie_ps4_end
	...
	void operator+=(const FCookStats &Other)
	{
		...
		ExternGRHIShaderCompileTime_DINGO += Other.ExternGRHIShaderCompileTime_DINGO;
		...
		ExternGRHIShaderCompileTime_PCD3D_SM4 += Other.ExternGRHIShaderCompileTime_PCD3D_SM4;
	...
	void LoadExternalStats()
	{
		...
		ExternGRHIShaderCompileTime_DINGO = GRHIShaderCompileTime_DINGO;
		...
		ExternGRHIShaderCompileTime_PCD3D_SM4 = GRHIShaderCompileTime_PCD3D_SM4;
	...
	void Serialize(FArchive& Ar)
	{
		...
		Ar <<  ExternGRHIShaderCompileTime_DINGO;
		...
		//Ar <<  ExternGRHIShaderCompileTime_PCD3D_SM4; // mathieu.gauthier: TODO: Enable for OL2, in the meantime breaks binary compatibility. Too lazy to version right now.
...
class UPersistentCookerData : public UObject
{
	...
	/**
	 * Directly reads CookedBulkDataInfoMap and CookedTextureFileCacheInfoMap from a raw .upk file,
	 * bypassing the UE3 linker. Used to load shipping PCD of a different package version.
	 *
	 * @param	Filename	Path to the .upk file
	 * @return	TRUE if the maps were populated successfully
	 */
	UBOOL LoadShippingMaps( const TCHAR* Filename );
