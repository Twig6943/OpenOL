...
private:
	...
	/** Callback for P2P session requests on the client (user) interface — used by FP2PBridge server mode */
	STEAM_CALLBACK(FOnlineAsyncTaskManagerSteam, OnClientP2PSessionRequestFunc, P2PSessionRequest_t, OnClientP2PSessionRequestCallback);
...
public:
	...
	FOnlineAsyncTaskManagerSteam()
		...
		, OnClientP2PSessionRequestCallback(this, &FOnlineAsyncTaskManagerSteam::OnClientP2PSessionRequestFunc)
