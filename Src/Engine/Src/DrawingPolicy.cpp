	...
	) const
{
	...
	{
		if (Initializer.FillMode == FM_Solid)
		{
		...
		else
		{
			switch (Initializer.CullMode)
			{
			case CM_None : RHISetRasterizerState(TStaticRasterizerState<FM_Wireframe, CM_None>::GetRHI()); break;
			case CM_CCW  : RHISetRasterizerState(TStaticRasterizerState<FM_Wireframe, CM_CCW >::GetRHI()); break;
			case CM_CW   : RHISetRasterizerState(TStaticRasterizerState<FM_Wireframe, CM_CW  >::GetRHI()); break;
			}
		}
	}
	else if (Initializer.DepthBias == -0.00006f && Initializer.SlopeScaleDepthBias == 0.0f)
	{
		if (Initializer.FillMode == FM_Solid)
		{
			switch (Initializer.CullMode)
			{
			case CM_None : RHISetRasterizerState(TStaticRasterizerState<FM_Solid, CM_None, -60>::GetRHI()); break;
			case CM_CCW  : RHISetRasterizerState(TStaticRasterizerState<FM_Solid, CM_CCW , -60>::GetRHI()); break;
			case CM_CW   : RHISetRasterizerState(TStaticRasterizerState<FM_Solid, CM_CW  , -60>::GetRHI()); break;
			}
		}
		else
		{
			switch (Initializer.CullMode)
			{
			case CM_None : RHISetRasterizerState(TStaticRasterizerState<FM_Wireframe, CM_None, -60>::GetRHI()); break;
			case CM_CCW  : RHISetRasterizerState(TStaticRasterizerState<FM_Wireframe, CM_CCW , -60>::GetRHI()); break;
			case CM_CW   : RHISetRasterizerState(TStaticRasterizerState<FM_Wireframe, CM_CW  , -60>::GetRHI()); break;
			}
		}
	}
	else
