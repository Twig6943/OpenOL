...
{
    UBOOL bInCinematicMode;
    UBOOL bAffectsMovement;
    UBOOL bAffectsTurning;
    UBOOL bAffectsHUD;
    PlayerController_eventClientSetCinematicMode_Parms(EEventParm)
    {
    }
};
struct PlayerController_eventSetCinematicMode_Parms
{
    ...
    UBOOL bAffectsMovement;
    UBOOL bAffectsTurning;
    UBOOL bAffectsButtons;
    PlayerController_eventSetCinematicMode_Parms(EEventParm)
    {
    }
};
...
{
    UBOOL _bEnableFading;
    FColor _FadeColor;
    FVector2D _FadeAlpha;
    FLOAT _FadeTime;
    UBOOL _bFadeAudio;
...
struct PlayerController_eventWwiseClientHearSound_Parms
{
    ...
    UBOOL bIsOccluded;
    PlayerController_eventWwiseClientHearSound_Parms(EEventParm)
    {
    }
};
...
struct PlayerController_eventCheckPrivileges_Parms
{
    PlayerController_eventCheckPrivileges_Parms(EEventParm)
    {
    }
};
...
public:
    ...
    BITFIELD bCanPlayOnline:1;
    BITFIELD bCanShareUserCreatedContent:1;
    BITFIELD bCinematicMode:1;
    BITFIELD bExcludeFromKismetPlayer:1;
    ...
    virtual void WwiseClientHearSound(class UAkEvent* ASound,class AActor* SourceActor,FVector SourceLocation,UBOOL bStopWhenOwnerDestroyed,UBOOL bIsOccluded=FALSE);
    ...
    DECLARE_FUNCTION(execWwiseClientHearSound)
    {
        P_GET_OBJECT(UAkEvent,ASound);
        P_GET_OBJECT(AActor,SourceActor);
        P_GET_STRUCT(FVector,SourceLocation);
        P_GET_UBOOL(bStopWhenOwnerDestroyed);
        P_GET_UBOOL_OPTX(bIsOccluded,FALSE);
        P_FINISH;
        this->WwiseClientHearSound(ASound,SourceActor,SourceLocation,bStopWhenOwnerDestroyed,bIsOccluded);
    }
    ...
    void eventClientSetCinematicMode(UBOOL bInCinematicMode,UBOOL bAffectsMovement,UBOOL bAffectsTurning,UBOOL bAffectsHUD)
    {
        PlayerController_eventClientSetCinematicMode_Parms Parms(EC_EventParm);
        Parms.bInCinematicMode=bInCinematicMode ? FIRST_BITFIELD : FALSE;
        Parms.bAffectsMovement=bAffectsMovement ? FIRST_BITFIELD : FALSE;
        Parms.bAffectsTurning=bAffectsTurning ? FIRST_BITFIELD : FALSE;
        Parms.bAffectsHUD=bAffectsHUD ? FIRST_BITFIELD : FALSE;
        ProcessEvent(FindFunctionChecked(ENGINE_ClientSetCinematicMode),&Parms);
    }
    void eventSetCinematicMode(class USeqAct_ToggleCinematicMode* Action,UBOOL bInCinematicMode,UBOOL bHidePlayer,UBOOL bAffectsHUD,UBOOL bAffectsMovement,UBOOL bAffectsTurning,UBOOL bAffectsButtons)
    {
        PlayerController_eventSetCinematicMode_Parms Parms(EC_EventParm);
        Parms.Action=Action;
        Parms.bInCinematicMode=bInCinematicMode ? FIRST_BITFIELD : FALSE;
        Parms.bHidePlayer=bHidePlayer ? FIRST_BITFIELD : FALSE;
        Parms.bAffectsHUD=bAffectsHUD ? FIRST_BITFIELD : FALSE;
        Parms.bAffectsMovement=bAffectsMovement ? FIRST_BITFIELD : FALSE;
        Parms.bAffectsTurning=bAffectsTurning ? FIRST_BITFIELD : FALSE;
        Parms.bAffectsButtons=bAffectsButtons ? FIRST_BITFIELD : FALSE;
        ProcessEvent(FindFunctionChecked(ENGINE_SetCinematicMode),&Parms);
    }
    ...
    void eventClientSetCameraFade(UBOOL _bEnableFading,FColor _FadeColor=FColor(EC_EventParm),FVector2D _FadeAlpha=FVector2D(EC_EventParm),FLOAT _FadeTime=0,UBOOL _bFadeAudio=FALSE)
    {
        PlayerController_eventClientSetCameraFade_Parms Parms(EC_EventParm);
        Parms._bEnableFading=_bEnableFading ? FIRST_BITFIELD : FALSE;
        Parms._FadeColor=_FadeColor;
        Parms._FadeAlpha=_FadeAlpha;
        Parms._FadeTime=_FadeTime;
        Parms._bFadeAudio=_bFadeAudio ? FIRST_BITFIELD : FALSE;
    ...
    void eventWwiseClientHearSound(class UAkEvent* ASound,class AActor* SourceActor,FVector SourceLocation,UBOOL bStopWhenOwnerDestroyed,UBOOL bIsOccluded=FALSE)
    {
        PlayerController_eventWwiseClientHearSound_Parms Parms(EC_EventParm);
        Parms.ASound=ASound;
        Parms.SourceActor=SourceActor;
        ...
        ProcessEvent(FindFunctionChecked(ENGINE_WwiseClientHearSound),&Parms);
    }
    ...
    {
        ProcessEvent(FindFunctionChecked(ENGINE_CheckPrivileges),NULL);
    }
...
AUTOGENERATE_FUNCTION(APlayerController,-1,execWwiseClientHearSound);
...
{ 
	...
	MAP_NATIVE(APlayerController, execWwiseClientHearSound)
