...
class USkeletalMeshComponent : public UMeshComponent
{
	...
	*/
	...
	BYTE CurrentFaceFXPriorityLevel;
...
// WWISEMODIF_START, alessard, nov-28-2008, WwiseAudioIntegration
	UBOOL	PlayFaceFXAnim(UFaceFXAnimSet* FaceFXAnimSetRef, const FString& AnimName, const FString& GroupName,class USoundCue* SoundCueToPlay,class UAkEvent* AkEventToPlay, FaceFXPriority Priority);
// WWISEMODIF_END
...
/** Global hook called at the end of USkeletalMeshComponent::UpdateSkelPose (SpaceBases/LocalAtoms are final).
    Default no-op; game code (OLHero.cpp) sets this to apply post-animation bone overrides. */
