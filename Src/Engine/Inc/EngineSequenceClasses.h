...
public:
    ...
    FLOAT TooFarWaitTime;
    FLOAT TooLongWaitTime;
    FLOAT DistInterested;
    FLOAT DistUninterested;
    FLOAT BlendInTime;
    FLOAT BlendOutTime;
...
public:
    ...
    BITFIELD bPlayThroughWorldReset:1;
    BITFIELD bShouldShowGore:1;
    BITFIELD bObserverOnly:1;
    BITFIELD bRemoteObserverMatinee:1;
    ...
    void InitInterp();
    void UpdateInterp(FLOAT NewPosition,UBOOL bPreview=FALSE,UBOOL bJump=FALSE,UBOOL bOnlyAIGroup=FALSE);
    void TermInterp();
    void Stop();
    ...
    DECLARE_FUNCTION(execInitInterp)
    {
        P_FINISH;
        this->InitInterp();
    }
    DECLARE_FUNCTION(execUpdateInterp)
    {
        P_GET_FLOAT(NewPosition);
        P_GET_UBOOL_OPTX(bPreview,FALSE);
        P_GET_UBOOL_OPTX(bJump,FALSE);
        P_GET_UBOOL_OPTX(bOnlyAIGroup,FALSE);
        P_FINISH;
        this->UpdateInterp(NewPosition,bPreview,bJump,bOnlyAIGroup);
    }
    DECLARE_FUNCTION(execTermInterp)
    {
        P_FINISH;
        this->TermInterp();
    }
...
{
public:
    //## BEGIN PROPS SeqAct_ToggleCinematicMode
    BITFIELD bDisableMovement:1;
    BITFIELD bDisableTurning:1;
    BITFIELD bHidePlayer:1;
    BITFIELD bDisableInput:1;
    BITFIELD bHideHUD:1;
    BITFIELD bDeadBodies:1;
    BITFIELD bDroppedPickups:1;
    BITFIELD bAllowCameraOffset:1;
    BITFIELD bLocalSpacePlayerControl:1;
    BITFIELD bDisableCollision:1;
    BITFIELD bDeactivateCamcorder:1;
    BITFIELD bRestoreCamcorder:1;
    BITFIELD bObserverOnly:1;
    FLOAT MinYaw;
    FLOAT MaxYaw;
    FLOAT MinPitch;
    ...
    FLOAT CameraSmoothingTime;
    class AActor* NewBase;
    //## END PROPS SeqAct_ToggleCinematicMode

    DECLARE_CLASS(USeqAct_ToggleCinematicMode,USequenceAction,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(USeqAct_ToggleCinematicMode)
};
...
{
public:
    //## BEGIN PROPS SeqEvent_PlayerSpawned
    class UObject* SpawnPoint;
    //## END PROPS SeqEvent_PlayerSpawned

    DECLARE_CLASS(USeqEvent_PlayerSpawned,USequenceEvent,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(USeqEvent_PlayerSpawned)
};
...
AUTOGENERATE_FUNCTION(USeqAct_Interp,-1,execTermInterp);
AUTOGENERATE_FUNCTION(USeqAct_Interp,-1,execUpdateInterp);
AUTOGENERATE_FUNCTION(USeqAct_Interp,-1,execInitInterp);
...
#define AUTO_INITIALIZE_REGISTRANTS_ENGINE_SEQUENCE \
	...
	USeqAct_ToggleCinematicMode::StaticClass(); \
	...
	USeqEvent_PlayerSpawned::StaticClass(); \
...
{ 
	...
	MAP_NATIVE(USeqAct_Interp, execTermInterp)
	MAP_NATIVE(USeqAct_Interp, execUpdateInterp)
	MAP_NATIVE(USeqAct_Interp, execInitInterp)
...
VERIFY_CLASS_OFFSET_NODIE(USeqAct_PlayFaceFXAnim,SeqAct_PlayFaceFXAnim,AkEventToPlay)
...
VERIFY_CLASS_OFFSET_NODIE(USeqAct_ToggleCinematicMode,SeqAct_ToggleCinematicMode,MinYaw)
VERIFY_CLASS_OFFSET_NODIE(USeqAct_ToggleCinematicMode,SeqAct_ToggleCinematicMode,NewBase)
VERIFY_CLASS_SIZE_NODIE(USeqAct_ToggleCinematicMode)
...
VERIFY_CLASS_OFFSET_NODIE(USeqCond_Increment,SeqCond_Increment,InitialValue)
...
VERIFY_CLASS_OFFSET_NODIE(USeqEvent_PlayerSpawned,SeqEvent_PlayerSpawned,SpawnPoint)
VERIFY_CLASS_SIZE_NODIE(USeqEvent_PlayerSpawned)
...
VERIFY_CLASS_OFFSET_NODIE(USeqEvent_Touch,SeqEvent_Touch,LastValidCheckpoint)
