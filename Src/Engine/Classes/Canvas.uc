...
/**
 * Pushes a 2D rotation matrix anchored at (CurX + W*AnchorX, CurY + H*AnchorY).
 * Matches DrawRotatedTile anchor semantics. Call PopTransform() when done.
 */
native noexport final function PushRotationMatrix(rotator Rotation, float W, float H, float AnchorX, float AnchorY);
