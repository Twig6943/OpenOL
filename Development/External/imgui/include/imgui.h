...
// - Add '#define IMGUI_DEFINE_MATH_OPERATORS' before including this file (or in imconfig.h) to access courtesy maths operators for ImVec2 and ImVec4.
// MSVC 2012 (VC11) does not support constexpr; define it away if not already defined by the caller.
// _ALLOW_KEYWORD_MACROS suppresses xkeycheck.h C1189 for this macro.
// We track whether WE defined it so we can undef it later without breaking callers who pre-defined it.
#if defined(_MSC_VER) && _MSC_VER < 1800 && !defined(constexpr)
#  ifndef _ALLOW_KEYWORD_MACROS
#    define _ALLOW_KEYWORD_MACROS
#  endif
#  define constexpr
#  define IMGUI_CONSTEXPR_DEFINED_LOCALLY
#endif
...
// Undefine constexpr compat shim if WE defined it (not if the caller pre-defined it)
#ifdef IMGUI_CONSTEXPR_DEFINED_LOCALLY
#  undef constexpr
#  undef IMGUI_CONSTEXPR_DEFINED_LOCALLY
#endif
