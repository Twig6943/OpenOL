...
public:
	...
	*/
	...
	virtual UBOOL IsFallbackMaterial() const { return FALSE; }
	...
	virtual UBOOL IsTessellationFrustumCullingEnabled() const { return FALSE; }
	virtual UBOOL IsTessellationBackfaceCullingEnabled() const { return FALSE; }
...
public:
	...
	static FCritialSectionHash CacheCriticalSectionHash;
#endif
	...
	virtual FString GetOwnerName() const { return TEXT(""); }
...
public:
	...
	virtual UBOOL IsFallbackMaterial() const;
	...
	virtual UBOOL IsTessellationFrustumCullingEnabled() const;
	virtual UBOOL IsTessellationBackfaceCullingEnabled() const;
