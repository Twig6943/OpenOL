...
public:
	...
	virtual void RebindFromMap(const class FShaderParameterMap& ParameterMap) {}
};
...
public:
	...
	void RebindFromMap(const FShaderParameterMap& ParameterMap) const
	{
		if(Parameters)
		{
			Parameters->RebindFromMap(ParameterMap);
		}
	}
