...
public:
	...
	{
//@zombie_ps4_begin
		return IsPCPlatform(Platform) || Platform == SP_PS3 || Platform == SP_ORBIS || Platform == SP_DINGO;
//@zombie_ps4_end
	}
};
...
public:
	...
	static UBOOL ShouldCache(EShaderPlatform Platform)
	{
		return IsPCPlatform(Platform) || Platform == SP_DINGO;	//@igs(nrm):  Not sure which of these makes sense on Dingo yet... need to research, but for now, cache them all
	}
};
...
*/
	...
	*/
	...
	{
		SceneTextureParams.Bind(ParameterMap);
		ScreenToShadowMatrixParameter.Bind(ParameterMap,TEXT("ScreenToShadowMatrix"),TRUE);
		InvRandomAngleTextureSize.Bind(ParameterMap,TEXT("InvRandomAngleTextureSize"),TRUE);
		...
		RefiningSampleOffsetsParameter.Bind(ParameterMap,TEXT("RefiningSampleOffsets"),TRUE);
		EdgeSampleOffsetsParameter.Bind(ParameterMap,TEXT("EdgeSampleOffsets"),TRUE);
		ShadowBufferSizeParameter.Bind(ParameterMap,TEXT("ShadowBufferSize"),TRUE);
...
*/
//@zombie_ps4_begin
extern FBranchingPCFProjectionPixelShaderInterface* SetBranchingPCFParameters(
//@zombie_ps4_end
	INT ViewIndex,
	const FSceneView& View, 
	const FProjectedShadowInfo* ShadowInfo,
