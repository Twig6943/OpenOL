...
// mathieu.gauthier: DLC HACK! We have shipped maps that have outdated
// shader maps since some usage flags have been added for the DLC. This
// this is OK since we were not using these shaders in the map.
#if !ORBIS
			bIsComplete = FALSE;
			break;
#endif
