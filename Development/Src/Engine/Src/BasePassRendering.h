...
/** mathieu.gauthier: The hero spotlight to be rendered in the base pass. */
extern FLightSceneInfo* GHeroLightSceneInfo;
...
#else
//@zombie_ps4_begin
	return GAllowDeferredShading && ShouldCompileDeferredShaders(GRHIShaderPlatform) && (GRHIShaderPlatform == SP_PCD3D_SM5 || GRHIShaderPlatform == SP_ORBIS || GRHIShaderPlatform == SP_DINGO);
//@zombie_ps4_end
#endif
}
...
protected:
		...
		FMeshMaterialVertexShader(Initializer)
	{
		...
		HeroLightPositionAndInvRadiusParameters.Bind(Initializer.ParameterMap,TEXT("HeroLightPositionAndInvRadius"),TRUE);
	}
...
public:
	...
	virtual UBOOL Serialize(FArchive& Ar)
	{
		...
		Ar << HeroLightPositionAndInvRadiusParameters;
		...
		)
	{
		...
		if (GHeroLightSceneInfo)
		{
			...
			GHeroLightSceneInfo->GetParameters(LightPositionAndInvRadius, LightColorAndFalloffExponent, LightDirection, SpotAngles);

			LightPositionAndInvRadius.X = (LightPositionAndInvRadius.X + View.PreViewTranslation.X) * LightPositionAndInvRadius.W;
			LightPositionAndInvRadius.Y = (LightPositionAndInvRadius.Y + View.PreViewTranslation.Y) * LightPositionAndInvRadius.W;
			LightPositionAndInvRadius.Z = (LightPositionAndInvRadius.Z + View.PreViewTranslation.Z) * LightPositionAndInvRadius.W;

			SetVertexShaderValue(
				GetVertexShader(),
				HeroLightPositionAndInvRadiusParameters,
	...
	{
		LightMapPolicyType::VertexParametersType::Bind(ParameterMap);
		MaterialParameters.RebindFromMap(ParameterMap);
		VertexFactoryParameters.RebindFromMap(ParameterMap);
		HeightFogParameters.Bind(ParameterMap);
		FogVolumeParameters.Bind(ParameterMap);
		HeroLightPositionAndInvRadiusParameters.Bind(ParameterMap,TEXT("HeroLightPositionAndInvRadius"),TRUE);
	}
...
private:
	...
	FShaderParameter HeroLightPositionAndInvRadiusParameters;
...
public:
		...
		FMeshMaterialPixelShader(Initializer)
	{
		...
		HeroLightEnabledParameters.Bind(Initializer.ParameterMap,TEXT("bHeroLightEnabled"),TRUE);
		HeroSpotDirectionParameters.Bind(Initializer.ParameterMap,TEXT("HeroSpotDirection"),TRUE);
		HeroSpotAnglesParameters.Bind(Initializer.ParameterMap,TEXT("HeroSpotAngles"),TRUE);
		HeroLightColorAndFalloffExponentParameters.Bind(Initializer.ParameterMap,TEXT("HeroLightColorAndFalloffExponent"),TRUE);
		HeroLightWorldPosInvRadiusParameters.Bind(Initializer.ParameterMap,TEXT("HeroLightWorldPosInvRadius"),TRUE);
	}
	TBasePassPixelShaderBaseType() {}

	virtual void RebindParameters(const FShaderParameterMap& ParameterMap)
	{
		LightMapPolicyType::PixelParametersType::Bind(ParameterMap);
		MaterialParameters.RebindFromMap(ParameterMap);
		AmbientColorAndSkyFactorParameter.Bind(ParameterMap,TEXT("AmbientColorAndSkyFactor"),TRUE);
		TemporalAAParameters.Bind(ParameterMap,TEXT("TemporalAAParametersPS"),TRUE);
		...
		DeferredRenderingParameters.Bind(ParameterMap,TEXT("DeferredRenderingParameters"),TRUE);
		HeroLightEnabledParameters.Bind(ParameterMap,TEXT("bHeroLightEnabled"),TRUE);
		HeroSpotDirectionParameters.Bind(ParameterMap,TEXT("HeroSpotDirection"),TRUE);
		HeroSpotAnglesParameters.Bind(ParameterMap,TEXT("HeroSpotAngles"),TRUE);
		HeroLightColorAndFalloffExponentParameters.Bind(ParameterMap,TEXT("HeroLightColorAndFalloffExponent"),TRUE);
		HeroLightWorldPosInvRadiusParameters.Bind(ParameterMap,TEXT("HeroLightWorldPosInvRadius"),TRUE);
	}
	...
	void SetParameters(const FVertexFactory* VertexFactory,const FMaterialRenderProxy* MaterialRenderProxy,const FMaterial& MaterialResource,const FSceneView* View,UBOOL bDrawLitTranslucencyUnlit)
	{
		...
		if (GHeroLightSceneInfo)
		{
			...
			LightPositionAndInvRadius.X = LightPositionAndInvRadius.X;
			LightPositionAndInvRadius.Y = LightPositionAndInvRadius.Y;
			LightPositionAndInvRadius.Z = LightPositionAndInvRadius.Z;

			SetPixelShaderValue(GetPixelShader(), HeroSpotDirectionParameters, -LightDirection);
			SetPixelShaderValue(GetPixelShader(), HeroSpotAnglesParameters, SpotAngles);
			SetPixelShaderValue(GetPixelShader(), HeroLightColorAndFalloffExponentParameters, LightColorAndFalloffExponent);
			SetPixelShaderValue(GetPixelShader(), HeroLightWorldPosInvRadiusParameters, LightPositionAndInvRadius);
		}
#endif
	}
	...
	void SetMesh(const FPrimitiveSceneInfo* PrimitiveSceneInfo,const FMeshBatch& Mesh, INT BatchElementIndex,const FSceneView& View,UBOOL bBackFace,EBlendMode BlendMode)
	{
		...
		{
			check(PrimitiveSceneInfo->HeroLightCount == 0 || PrimitiveSceneInfo->HeroLightCount == 1);
			UBOOL bAffectedByHeroLight = PrimitiveSceneInfo->HeroLightCount > 0;
			SetPixelShaderBool(GetPixelShader(), HeroLightEnabledParameters, bAffectedByHeroLight);
		}
#endif
	...
	virtual UBOOL Serialize(FArchive& Ar)
	{
		...
		Ar << HeroLightEnabledParameters;
		Ar << HeroSpotDirectionParameters;
		Ar << HeroSpotAnglesParameters;
		Ar << HeroLightColorAndFalloffExponentParameters;
		Ar << HeroLightWorldPosInvRadiusParameters;
...
private:
	...
	FShaderParameter HeroLightEnabledParameters;
	FShaderParameter HeroSpotDirectionParameters;
	FShaderParameter HeroSpotAnglesParameters;
	FShaderParameter HeroLightColorAndFalloffExponentParameters;
	FShaderParameter HeroLightWorldPosInvRadiusParameters;
};
...
//@zombie_ps4_begin
		if ( (GRHIShaderPlatform == SP_PCD3D_SM5 || GRHIShaderPlatform == SP_ORBIS || GRHIShaderPlatform == SP_DINGO)
//@zombie_ps4_end
