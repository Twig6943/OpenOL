...
public:
	...
	virtual void BuildShaderParameterMap(const TArray<BYTE>& Code, FShaderParameterMap& OutParameterMap);
...
private:
	...
	// mathieu.gauthier: Caching color writes because we will do a lot of 
	// these with the skin shading (until we switch to deferred).
	DWORD CachedColorWriteStates[4];
